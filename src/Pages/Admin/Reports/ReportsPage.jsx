                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-2">
                                <button
                                    onClick={() => {
                                        if (role === "admin") {
                                            navigate("/admin/reports/history");
                                        } else if (role === "trainer") {
                                            navigate("/trainer/reports/history");
                                        } else {
                                            navigate("/college_rep/reports/history");
                                        }
                                    }}
                                                ...
                                                >
                                                    ...
                                                    {(() => {
                                                        ...
                                                        if (start > 1) {
                                                            ...
                                                            if (start > 2) {
                                                                pages.push(
                                                                    <span key="dots-start" className="px-3 py-2 text-gray-400">
                                                                        ...
                                                                    </span>
                                                                );
                                                            }
                                                        ...
                                                        if (end < totalPages) {
                                                            if (end < totalPages - 1) {
                                                                pages.push(
                                                                    <span key="dots-end" className="px-3 py-2 text-gray-400">
                                                                        ...
                                                                    </span>
                                                                );
                                                            }
