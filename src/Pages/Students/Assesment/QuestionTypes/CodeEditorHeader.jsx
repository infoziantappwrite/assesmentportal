        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex gap-1">
            ...
            <button
              ...
              disabled={executionState.isRunning || submitStatus === "success" || isAnswerSubmitted?.isAlreadyExecuted}
            ...
            <button
              ...
              disabled={isAnswerSubmitted?.isAlreadyExecuted}
              className={`relative group z-50 p-1 rounded-md flex items-center justify-center 
                ${isAnswerSubmitted?.isAlreadyExecuted
                  ? "bg-gray-300 text-gray-600 border-gray-400 cursor-not-allowed"
            ...
            <button
              ...
              disabled={saveStatus === "saving" || submitStatus === "success" || isAnswerSubmitted?.isAlreadyExecuted}
